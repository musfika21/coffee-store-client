    ...
    return (
        <footer className='base-font'>
            <div className='footer-bg1'>
                <div className='max-w-6/7 mx-auto pt-18 pb-10 flex items-center'>
                    {/* left content */}
                    <div className='space-y-4'>
                        ...
                        <ul className='text-[#331A15] flex text-3xl gap-3'>
                            <li>
                                <a href=""><FaFacebook /></a>
                            </li>
                            <li>
                        ...
                        <ul className='text-[#331A15] space-y-2'>
                    ...
                    <div className='space-y-3'>
                        ...
                        <input className='bg-white p-3 rounded-lg text-[#331A15]' type="text" name="name" placeholder='Name' />
                        <br/>
                        <input className='bg-white p-3 rounded-lg text-[#331A15]' type="email" name="email" placeholder='Email' />
                        <br/>
                        <textarea className='bg-white p-3 rounded-lg text-[#331A15]' name="text" placeholder='Message' rows="5"></textarea>
                    </div>
                </div>
            </div>
